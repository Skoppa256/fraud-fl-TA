"""Server-side evaluation for BertFraud.

Each round, rebuilds a :class:`BertFraudModel` from the aggregated parameters
and scores AUPRC/F1/Precision/Recall on the held-out validation set. On the
final round the test set is also scored using the threshold tuned on val.
"""
...
def _build_model(cfg: dict, input_dim: int) -> BertFraudModel:
